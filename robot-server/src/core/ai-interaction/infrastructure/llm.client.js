    ...
    const responses = [
      {
        ...
        actions: [{ action: 'sit', params: {} }],
        quest: null,
      },
      {
        text: '哼！你以为你是谁啊？不过... 好吧，让我给你表演一下！',
        actions: [{ action: 'kick', params: {} }],
        quest: null,
      },
      {
        text: '喵呜~ 今天心情不错！让我来陪你玩吧！',
        actions: [{ action: 'walk', params: {} }],
        quest: null,
      },
      {
      ...
      },
      {
        ...
        actions: [{ action: 'play', params: {} }],
        quest: null,
      },
      {
        text: '喵呜！我才不是你的玩具呢！不过... 偶尔陪你玩玩也行。',
        actions: [{ action: 'jump', params: {} }],
        quest: null,
      },
      {
        text: '哼，看在你给我准备了好吃的份上，就陪你一会儿吧！',
        actions: [{ action: 'eat', params: {} }],
        quest: null,
      },
      {
        text: '喵~ 你看我这毛茸茸的尾巴，是不是很可爱？',
        actions: [{ action: 'swing', params: {} }],
        quest: null,
      },
      {
        text: '呼噜呼噜~ 今天天气真好，适合在窗台上打盹！',
        actions: [{ action: 'sleep', params: {} }],
        quest: null,
      },
      {
      ...
      },
      {
        ...
        actions: [{ action: 'forward', params: {} }],
        quest: null,
      },
      {
        text: '喵~ 我刚抓了一只老鼠，要不要看看？开玩笑的啦！',
        actions: [{ action: 'run', params: {} }],
        quest: null,
      },
      {
        text: '咕噜~ 主人你终于回来了，我等你好久了！',
        actions: [{ action: 'follow', params: {} }],
        quest: null,
      },
      {
      ...
      },
      {
        ...
        actions: [{ action: 'shakehand', params: {} }],
        quest: null,
      },
      {
